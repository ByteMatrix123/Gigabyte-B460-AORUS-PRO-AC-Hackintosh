/*
 * Patched DMAR table for macOS.
 *
 * Source: SysReport/ACPI/DMAR-1.aml
 * Method: Dortania manual DMAR patch, removing Reserved Memory Region
 *         subtables while keeping the original DRHD hardware units.
 */
